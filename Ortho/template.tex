...
\begin{figure}[htbp]
    \centering{\includegraphics[width=0.8\columnwidth]{Figures/graph2.png}}
...
\begin{figure}[htbp]
    \centering{\includegraphics[width=\columnwidth]{Figures/Methodology.png}}
    \caption{Pipeline}
    \label{pipeline}
\end{figure}
...
\begin{figure}[htbp]
    \centering{\includegraphics[width=0.75\columnwidth]{Figures/compare.png}}
...
\begin{figure*}[htbp]
    \centering{\includegraphics[width=\textwidth]{Figures/pixel.png}}
